...
Example:
python delete_unmapped_files.py -a https://gen3.datacommons.io/ -u user@datacommons.org -c ~/Downloads/credentials.json
...
def parse_args():
    ...
    parser.add_argument("-a", "--api", required=True, help="The data commons URL.",default="https://gen3.datacommons.io/")
    parser.add_argument("-u", "--user", required=True, help="The user's login email.",default="cgmeyer@uchicago.edu")
    parser.add_argument("-c", "--creds", required=True, help="The location of the credentails.json file containing the user's API keys downloaded from the /profile page of the commons.", default="~/Downloads/credentials.json")
...
def uploader_index():
    ...
    Examples:
        ...
        #https://gen3.datacommons.io/index/index/?limit=1024&acl=null&uploader=cgmeyer@uchicago.edu
    """
    global guids
